    ...
    <section className="bg-white my-10">
      <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        ...
        <div className="inline-flex w-full mt-6 sm:w-auto">
          <a href="#" className="inline-flex items-center justify-center w-full px-6 py-2 text-white duration-300 bg-yellow-600 rounded-lg hover:bg-yellow-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                Daftar di sini
          </a>
        </div>
      </div>
